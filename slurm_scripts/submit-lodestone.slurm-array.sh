...
#SBATCH --output=slurm_logs/lodestone_%A-%a.out	# Standard output log
#SBATCH --error=slurm_logs/lodestone_%A-%a.err	# Standard error log
#SBATCH --array=1-5%5			# Array range
